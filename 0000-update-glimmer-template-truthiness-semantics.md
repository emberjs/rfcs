...
### Migration Plan
1. Ship comparison helpers `and`, `or`, `not` with existing equality and truthiness semantics.
...
3. Ship ability to opt into new behavior (Following JS truthiness semantics)
